...
export const DETAILS: Detail =  
    {
        ...
        skills: [
            ...
            {
                name:'Bootstrap/HTML/JavaScript',
                progress: 'width:50%',
                progressval: '50'
            },
            {
                name:'Java/Android/Spring-boot',
                progress: 'width:60%',
                progressval: '50'
            },
            {
                name:'Word/Excel/Photoshop',
                progress: 'width:60%',
                progressval: '50'
            },
            {
                name:'Git/Trello/Postman/ChromeDevTools',
                progress: 'width:20%',
                progressval: '50'
            },
            {
                name:'Documentation Writing/Communication',
                progress: 'width:80%',
                progressval: '50'
            }
        ],
